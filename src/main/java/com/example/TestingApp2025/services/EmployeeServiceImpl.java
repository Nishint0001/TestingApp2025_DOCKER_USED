...
import com.example.TestingApp2025.exceptions.ResourceNotFoundException;
...
public class EmployeeServiceImpl implements EmployeeService
{
    ...
    {
        EmployeeEntity employeeEntity=employeeRepo.findById(id).orElseThrow(()->new ResourceNotFoundException("ID NOT EXIST"));
